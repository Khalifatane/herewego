...
function requireEnv(name, value) {
  if (!value) {
    console.warn(`Missing Sanity environment variable: ${name}. Using fallback.`);
    return name === "VITE_SANITY_PROJECT_ID" ? "o85ja9mx" : "production";
  }
...
export function getSanityConfig() {
  const projectId =
    import.meta.env.VITE_SANITY_PROJECT_ID || "o85ja9mx";
  const dataset =
  ...
  return {
    ...
    useCdn: true, // Always use CDN for static builds to avoid CORS
